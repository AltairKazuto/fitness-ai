...
const currentDayLog = computed<DailyLog | undefined>(() => {
  ...
  const sortedLogs = [...props.dailyLogs].sort(
  ...
  <div class="min-h-screen bg-gray-900 text-gray-100 p-8">
    <header class="flex justify-between items-center mb-8">
      ...
      <div class="space-x-4">
        <RouterLink to="/game">
          <button
            class="bg-teal-600 hover:bg-teal-500 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 shadow-lg"
          >
            Go to Game
          </button>
        </RouterLink>
        <RouterLink to="/">
          <button
            @click="state.authenticated = false"
            class="bg-red-600 hover:bg-red-500 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 shadow-lg"
          >
            Logout
          </button>
        </RouterLink>
    ...
    <div class="mb-12 bg-gray-800 p-6 py-10 rounded-xl shadow-2xl border border-gray-700">
      <div class="flex">
        ...
        <div class="flex flex-col justify-begin mx-6 my-4 mb-4">
          ...
          <h2 class="text-2xl font-semibold text-white mb-1 leading-none">Progress for Today</h2>
    ...
    <div class="bg-gray-800 p-6 rounded-xl shadow-2xl overflow-x-auto border border-gray-700">
      <table class="min-w-full divide-y divide-gray-700">
        ...
        <tbody class="bg-gray-800 divide-y divide-gray-700">
          <tr
            v-for="log in props.dailyLogs"
            :key="log.id"
            class="hover:bg-gray-700 transition duration-100"
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center space-x-3">
                ...
                <span
                  ...
                  :class="isGoalMetComputed(log) ? 'text-green-400' : 'text-yellow-400'"
                >
            ...
            <td class="px-6 py-4 whitespace-nowrap text-s text-gray-300">
              <span class="font-bold text-white">{{ log.earned_points }}</span> /
              {{ log.goal_points }}
            </td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-s font-medium">
              ...
              <div v-else class="text-yellow-400">Still Working</div>
            </td>
          </tr>
        </tbody>
      </table>
